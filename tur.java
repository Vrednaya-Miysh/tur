...
public class tur {
          public static void main (String [] args) throws java.io.IOException{
            ...
            int Ekskurs = sc3.nextInt();                  /* запоминает данные для формирования пакета экскурсий на отдыхе*/
            
            System.out.print("длительность тура(количество дней): ");/* ввод*/
            Scanner sc4 = new Scanner (System.in);          /* считывает общие данные для расчета длительности тура*/
            int dlitelnost = sc4.nextInt();                /* запоминает общие данные для расчета длительности тура*/    
